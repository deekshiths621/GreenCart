        ...
        (
          <div className='relative group'>
            ...
            <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-40 rounded-md text-sm z-40'>
              ...
              <li onClick={()=> navigate("/track-order")} className='p-1.5 pl-3 hover:bg-primary/10 cursor-pointer'>Track Order</li>
...
<div className='flex items-center gap-6 sm:hidden'>
    ...
    <button onClick={() => open ? setOpen(false) : setOpen(true)} aria-label="Menu" className="">
      ...
      { open && (
        ...
        <NavLink to="/track-order" onClick={()=> setOpen(false)}>Track Order</NavLink>
        </>
        }
